import { KeplrError, Message, MessageRequester, Result, JSONUint8Array } from '@keplr-wallet/router'
import EventEmitter from 'eventemitter3'

import { RNRouterBackground, RNRouterUI } from './RNRouter'
...
export class RNMessageRequesterBase implements MessageRequester {
  public constructor(
    ...
    protected readonly getSender: () => {
      ...
      // By default, `getSender` returns the information as internal sender.
      // If the sender is not internal, you should provide your own sender.
      return {
