...
const translation = {
  ...
  "Biometry": {
    ...
    "EnabledText1": "Log in with your phone's biometrics instead of your wallet PIN. This means all fingerprint and facial data added on this phone can be used to access your Hiero Wallet App.",
    "EnabledText2": "Ensure only you have access to your Hiero Wallet App.",
    "Warning": "Ensure only you have access to your Hiero Wallet App.",
    "UseToUnlock": "Use biometrics to unlock the app",
    "Skip": "Skip",
    "EnabledTitle": "Biometrics use",
    "EnabledDescription": "You need to set up biometrics in the device settings first and then you will be able to enable it for accessing Hiero Wallet App.",
  ...
  "Onboarding": {
    "Welcome": "Welcome",
    "WelcomeParagraph1": "Hiero Wallet App allows you to receive, store and use digital credentials.",
    ...
    "StoredSecurelyBody": "Hiero Wallet App holds digital credentials — the digital versions of things like licenses, identities, permits, medical prescriptions and etc. They are stored securely, only on this device.",
    ...
    "PrivacyParagraph": "You approve every use of information from your Hiero Wallet App. You also only share what is needed for a situation. App administration or other third parties are not informed on when and how you use your digital credentials.",
    "KeplrWalletTitle": "Keplr wallet integration",
    "KeplrWalletBody": "Hiero Wallet App provides crypto wallet functionality by integrating open-source Keplr wallet. This wallet can be used to receive and transfer various crypto tokens.\n\nYou can access your crypto wallet using ”Open Keplr wallet” button on a home screen.",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "You're unable to access services using Hiero Wallet or receive credentials until you're back online.\n\nPlease check your internet connection."
  },
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the Hiero Wallet scan feature, please allow camera permissions.",
    "Allow": "Allow",
    "OpenSettings": "Open settings",
  },
  "Scan": {
    "ScanOnySpecial": "Only specific QR codes can be scanned by Hiero Wallet.",
    "ScanOnlySpecial3": "Hiero Wallet currently doesn't support adding digital credential by scanning or taking photos of physical ones.",
    "WhereToUseLink": "See where you can use Hiero Wallet",
    "BadQRCodeDescription": "Ths QR code scanned doesn't work with Hiero Wallet. Hiero Wallet only works with participating services.\n\nIt currently can't add digital credentials by taking photos of physical ones."
  },
  "Settings": {
