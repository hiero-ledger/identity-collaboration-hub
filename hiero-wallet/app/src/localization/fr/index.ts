...
const translation = {
  ...
  "Biometry": {
    ...
    "EnabledText1": "Connectez-vous avec la biométrie de votre téléphone plutôt qu'avec le code PIN de votre portefeuille. Cela signifie que toutes les données d'empreintes digitales et faciales ajoutées sur ce téléphone peuvent être utilisées pour accéder à votre application Hiero Wallet.",
    "EnabledText2": "Assurez-vous que seul vous pouvez accéder à votre application Hiero Wallet.",
    "Warning": "Assurez-vous que seul vous pouvez accéder à votre application Hiero Wallet.",
  ...
  "Onboarding": {
    "Welcome": "Bienvenue",
    "WelcomeParagraph1": "L'application Hiero Wallet vous permet de recevoir, stocker et utiliser des certificats numériques.",
    ...
    "StoredSecurelyBody": "Hiero Wallet stocke des certificats numériques — les versions numériques de documents tels que permis, identités, autorisations, ordonnances médicales, etc. Ils sont stockés de manière sécurisée, uniquement sur cet appareil.",
    ...
    "PrivacyParagraph": "Vous autorisez chaque utilisation des informations de votre application Hiero Wallet. Vous ne partagez que ce qui est nécessaire pour une situation donnée. L'administration de l'application ou des tiers ne sont pas informés de l'utilisation de vos certificats numériques.",
    "KeplrWalletTitle": "Intégration du portefeuille Keplr",
    "KeplrWalletBody": "Hiero Wallet offre une fonctionnalité de portefeuille crypto en intégrant le portefeuille open-source Keplr. Ce portefeuille peut être utilisé pour recevoir et transférer divers jetons cryptographiques.\n\nVous pouvez accéder à votre portefeuille crypto en utilisant le bouton « Ouvrir le portefeuille Keplr » sur l'écran d'accueil.",
  ...
  "Screens": {
    "Onboarding": "Hiero Wallet"
  },
  "NetInfo": {
    "NoInternetConnectionTitle": "Pas de connexion Internet",
    "NoInternetConnectionMessage": "Vous ne pouvez pas accéder aux services via Hiero Wallet ni recevoir de certificats tant que vous n'êtes pas reconnecté.\n\nVeuillez vérifier votre connexion Internet."
  },
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "Pour continuer à utiliser la fonction de scan de Hiero Wallet, veuillez autoriser les permissions de la caméra.",
    "Allow": "Autoriser",
    "OpenSettings": "Ouvrir les paramètres"
  },
  "Scan": {
    "ScanOnySpecial": "Seuls des QR codes spécifiques peuvent être scannés par Hiero Wallet.",
    "ScanOnlySpecial3": "Hiero Wallet ne prend actuellement pas en charge l'ajout de certificats numériques en scannant ou en prenant des photos de documents physiques.",
    "WhereToUseLink": "Voir où vous pouvez utiliser Hiero Wallet",
    "BadQRCodeDescription": "Le QR code scanné n'est pas compatible avec Hiero Wallet. Hiero Wallet fonctionne uniquement avec des services participants.\n\nIl ne peut pas ajouter de certificats numériques en prenant des photos de documents physiques."
  },
  "Settings": {
