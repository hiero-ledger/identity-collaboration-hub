...
const translation = {
  ...
  "Biometry": {
    ...
    "EnabledText1": "Faça login com a biometria do seu telefone em vez do PIN da carteira. Isso significa que todos os dados de impressão digital e reconhecimento facial cadastrados neste telefone podem ser usados para acessar o aplicativo Hiero Wallet.",
    "EnabledText2": "Garanta que somente você tenha acesso ao seu aplicativo Hiero Wallet.",
    "Warning": "Garanta que somente você tenha acesso ao seu aplicativo Hiero Wallet.",
  ...
  "Onboarding": {
    "Welcome": "Bem-vindo",
    "WelcomeParagraph1": "O aplicativo Hiero Wallet permite que você receba, armazene e use credenciais digitais.",
    ...
    "StoredSecurelyBody": "O Hiero Wallet armazena credenciais digitais — versões digitais de documentos como licenças, identidades, autorizações, receitas médicas, etc. Elas são armazenadas de forma segura, apenas neste dispositivo.",
    ...
    "PrivacyParagraph": "Você aprova cada uso das informações do seu aplicativo Hiero Wallet. Você também compartilha apenas o necessário para cada situação. A administração do aplicativo ou terceiros não são informados sobre quando e como você utiliza suas credenciais digitais.",
    "KeplrWalletTitle": "Integração com a carteira Keplr",
    "KeplrWalletBody": "O Hiero Wallet oferece funcionalidade de carteira de criptomoedas integrando a carteira Keplr de código aberto. Esta carteira pode ser usada para receber e transferir vários tokens criptográficos.\n\nVocê pode acessar sua carteira de criptomoedas utilizando o botão “Abrir carteira Keplr” na tela inicial.",
    "GetStarted": "Começar",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "Você não pode acessar os serviços usando o Hiero Wallet ou receber credenciais até estar online.\n\nPor favor, verifique sua conexão com a internet."
  },
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "Para continuar usando o recurso de escaneamento do Hiero Wallet, por favor permita o acesso à câmera.",
    "Allow": "Permitir",
    "OpenSettings": "Abrir configurações"
  },
  "Scan": {
    "ScanOnySpecial": "Apenas códigos QR específicos podem ser escaneados pelo Hiero Wallet.",
    "ScanOnlySpecial3": "O Hiero Wallet atualmente não suporta a adição de credenciais digitais por meio do escaneamento ou fotografias de documentos físicos.",
    "WhereToUseLink": "Veja onde você pode usar o Hiero Wallet",
    "BadQRCodeDescription": "O código QR escaneado não é compatível com o Hiero Wallet. O Hiero Wallet funciona apenas com serviços participantes.\n\nAtualmente, não é possível adicionar credenciais digitais por meio de fotografias de documentos físicos."
  },
  "Settings": {
